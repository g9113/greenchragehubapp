import 'package:greenchargehub/api_osrm.dart';
import 'package:greenchargehub/consts.dart';
import 'package:greenchargehub/direction_page.dart';
import 'package:greenchargehub/models/gas_station.dart';
import 'package:greenchargehub/models/overviews.dart';
import 'package:greenchargehub/widgets/booking.dart';
import 'package:greenchargehub/widgets/custom_marker.dart';
import 'package:greenchargehub/widgets/overview_item.dart';
...
class DetailPage extends StatefulWidget {
  ...
  const DetailPage(
      {super.key, required this.gasStation, required this.distance});
                ...
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) => BookingScreen(
                              admin: widget.gasStation.adminid,
                              address: widget.gasStation.address,
                              price: widget.gasStation.price.toString(),
                              stationname: widget.gasStation.name, number: "8596709876",
                            )));
              },
              child: Container(
                padding:
                ...
                child: Row(
                  children: [
                    Text(
                      'Book Now',
                      style:
                          roboto.copyWith(fontSize: 6.f, color: Colors.white),
                    ),
                    SizedBox(width: 2.w),
                    const Icon(
